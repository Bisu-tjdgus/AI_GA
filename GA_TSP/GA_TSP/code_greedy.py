...
class Tour:
    ...
    def genrateGreedy(self):
        for cityIndex in range(0, self.tourmanager.numberOfCities()):
            self.setCity(cityIndex, self.tourmanager.getCity(greedy_city[cityIndex]))
...
class Population:
    def __init__(self, tourmanager, populationSize, initialise):
        ...
        if initialise:
            ...
            newTour.genrateGreedy()
            self.saveTour(0, newTour)
...
if __name__ == '__main__':
    ...
    for i in range(n_generations):
        ...
        cv2.line(
            map_result,
            pt1=(int(9 * fittest[999].x), int(9 * fittest[999].y)),
